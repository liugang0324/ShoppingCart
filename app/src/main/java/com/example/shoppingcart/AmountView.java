...
import com.example.shoppingcart.shopp.ShoppingCartAdapter;
...
public class AmountView extends LinearLayout implements View.OnClickListener, TextWatcher {
    ...
    public void onClick(View v) {
        ...
        if (mListener != null) {
            mListener.onAmountChange(this, amount,flag);
        }
    }
    ...
    public interface OnAmountChangeListener {
        void onAmountChange(View view, int amount,boolean flag);
    }
}
